...
parameters = [
    ...
    ["radius_blob",   "Ang",        4.0,  [0.0, inf], "", "Radius of the Gaussian in the blob"],
    ...
    ["n_aggblob",     "",           5.0,  [0, inf],    "", "Number of blob in the core"],
    ]
# pylint: enable=bad-whitespace, line-too-long

single = False

source = ["lib/sas_3j1x_x.c", "blob.c"]
