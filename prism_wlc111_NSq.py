...
parameters = [
    ...
    ["N_a",            "",            1.0, [0, 100],    "",       "Aggregates number"],
    ["D_a",            "Ang",          10, [0, inf],    "",       "Distance between aggregates"],
    ["conc",        "100*w/w",      1.0, [0, 100],    "",       "Concentration of polymer"],
    ["wamw",        "g mol^-1",   40000, [0, inf],    "",       "Weight-averaged molecular weight" ]
    ]
# pylint: enable=bad-whitespace, line-too-long
source = ["lib/polevl.c", "lib/sas_J1.c", "lib/wrc_cyl.c", "prism_wlc111_NSq.c"]
...
def random():
    ...
    N_a = 10**np.random.uniform(0,1)
    D_a = 10**np.random.uniform(0,2)
    pars = dict(
        length=length,
        radius=radius,
